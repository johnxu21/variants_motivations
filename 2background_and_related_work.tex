...
\item \textit{Legal issues.} This includes disagreements on the license and trademarks, and changes to conform to rules and regulations. An example is \textsf{X.Org}, which originated from \textsf{XFree86} ~\cite{Gregorio:2012,Wheeler:2015Forking}. \textsf{XFree86} was originally \textsf{MIT/X} open source license that is GPL-compatible and then they changed it to was not \sd{this "was not" is gramatically incorrect; confusing sentence} GPL-compatible causing many practical problems and a serious uproar in the community. Users and some of the developers forked the project, creating a new project at \textsf{X.Org} based on the previous version of \textsf{XFree86}.
