...
\vspace{-.3cm}
    \hfill
        ...
        \label{fig:decision}}
    \hfill
    \subfigure[What was the motivation for creating the variant of the mainline project?]{\includegraphics[width=1\columnwidth]{pdfs/likert_motivations_1.pdf}
...
\nd \textbf{Technical.} \dashuline{Maintenance} is the most frequently mentioned reason for the \dashuline{technical} motivation. 19 of the 84 survey participants who selected \dashuline{technical}, mentioned phrases related to \emph{performing bug/security fixes}.
...
\nd Another \dashuline{technical} motivation was \dashuline{customization}.
...
\nd The next \dashuline{technical} motivation was \dashuline{unmaintained feature}.
...
\nd A final \dashuline{technical} motivation was \dashuline{technology}.
...
\nd The next \dashuline{governance} motivation was \dashuline{feature acceptance}.
...
The most prominent motivation for \dashuline{others} is  \dashuline{supporting personal projects}. 8 of the 24 respondents who selected \dashuline{others} mentioned phrases related to \emph{variant was created to support personal projects}.
...
\nd The next motivation for  \dashuline{others} was \dashuline{supporting mainline}, which was mentioned by
7 respondents who selected \dashuline{others}:
...
\vspace{-.3cm}
    \hfill
        \subfigure[$SQ^2_{a}$. How many mainline developers involved in creation of variant?]{\includegraphics[width=1\columnwidth]{pdfs/original_developers.pdf}
        \label{fig:original}}
    \hfill
...
Fig.~\ref{fig:original} and Fig.~\ref{fig:common} summarise the answers to $SQ^2_{a}$ and $SQ^2_{b}$, respectively. 
The majority of the respondents chose the options of \dashuline{none} for $SQ^2_{a}$ (none of the creators of the variant were part of the mainline) and \dashuline{no} for  $SQ^2_{b}$ (they do not have common active maintainers).
...
Fig.~\ref{fig:sankey_motivation} reveals the difference in the numbers of participants who selected  \dashuline{none} for $SQ^2_{a}$ and \dashuline{no} for $SQ^2_{b}$.
Focusing at how responses of $SQ^2_{a}$--\dashuline{original developers?} and $SQ^2_{b}$--\dashuline{common active maintainers?} are associated, one can observe that most respondents that selected option \dashuline{none} in $SQ^2_{b}$ went ahead to select option \dashuline{no} in $SQ^2_{a}$. Other associations between responses of $SQ^2_{a}$ and $SQ^2_{b}$ can be observed as well.
...
We allowed respondents to provide an open-ended answer if they felt that their choice was not among the four proposed options. The open-ended answers were coded into themes (listed in Fig.~\ref{fig:discussions} from \dashuline{variant follows mainline}\ra to \dashuline{variant is a mirror of the mainline}).
Fig.~\ref{fig:discussions} shows that more than half of the respondents chose the option of \dashuline{never} (corresponding to: \textit{no, there has never been any discussion since the creation of the variant}). 
...
\vspace{-.3cm}
    \hfill
        \subfigure[Code integration back from the mainline]{\includegraphics[width=1\columnwidth]{pdfs/likert_integration_from_mainline.pdf}
        \label{fig:from_mainline}}
    \hfill
    \subfigure[Code integration from variant to mainline]{\includegraphics[width=1\columnwidth]{pdfs/likert_integration_to_mainline.pdf}
    \label{fig:to_mainline}}
    \hfill
    \subfigure[integration back from the mainline (coded themes)]{\includegraphics[width=1\columnwidth]{pdfs/changes_from_mainline.pdf}
        \label{fig:from_mainline-coded}}
    \hfill
    \subfigure[integration from variant to mainline (coded themes) ]{\includegraphics[width=1\columnwidth]{pdfs/changes_to_mainline.pdf}
...
%
We provided Likert-scale options for the two questions. We presented optional follow-up questions with open-ended answers, for each of the two questions, allowing respondents to provide extra information.
...
One can observe that most respondents were leaning towards the negative side of the Likert scale, implying hat most variants are not interested in integrating changes from the mainline.
...
We also observed limited interaction between the mainline and its variant(s).
...
1) \textit{technical divergency}: variants and mainlines are offering different goals, implementing different technologies, variant is maintaining a part of the mainline that is frozen;\\
...
This study reveals that some variant maintainers are only interested in integrating commits with specific changes.
