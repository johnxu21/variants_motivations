...
Although collaboration and maintenance has on social coding platforms like \gh have improved through the tooling like \git tools and PRs, these tools are not adequate are only idea for social forks which aim to sync all the changes between repositories.
