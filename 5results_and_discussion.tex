...
\section{Results -- $RQ1$}
\label{sec:results-RQ1}
Recall that in Section~\ref{sec:intro} we stated $RQ1$--\textbf{\RQOne} The goal of this RQ was to investigate whether the motivations for creating variant forks identified before the advent of social coding platforms still hold or whether new factors have come into play since then. To do so, we asked the survey participants the following questions:
...
Recall that in Section~\ref{sec:intro} we stated $RQ2$ \textbf{\RQTwo} The goal of this RQ was
