...
All questions were carefully formulated so as not to bias respondents towards a specific answer. We validated the formulation (1) by subjecting them to the critical eye of many \sd{how many is "many"? just say the exact number} colleagues; and (2) by conducting informal mini-runs of the survey with a limited group of 7 participants to obtain their feedback on.%\tm{Can you be more precise than say "a limited group of"? Just provide the number.}
