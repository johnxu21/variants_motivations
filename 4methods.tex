...
\ad{@John: Could you bring more details about the survey? (if any) Currently, this is not very informative. Also, I believe it would be nice to provide a link to the survey to that readers can see exactly what we asked. If you do so, please remember that SANER follows a double-blind review process, so the survey should be anonymized.}
...
Overall from the three methods we followed, we collected \textbf{a total of 491 mainline--variant pairs}.\ad{@John: 225 + 227 + 40 = 492.}
