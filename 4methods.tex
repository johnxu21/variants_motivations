...
The used survey can be found at \url{https://doi.org/10.5281/zenodo.5590013}.
...
The set of possible answers originated from our literature review.
...
All questions were carefully formulated so as not to bias respondents towards a specific answer. We validated the formulation (1) by subjecting them to the critical eye of many colleagues; and (2) by conducting informal mini-runs of the survey with a limited group of participants to obtain their feedback on it.\tm{Can you be more precise than say "a limited group of"? Just provide the number.}
...
Then, for all the mainline projects we found, we tried to  identify and collect variant forks. This process is subject to many threats since previous studies revealed that the majority of forks on \gh are inactive~\cite{Businge:Android:2019,Businge:2017} or are social forks~\cite{businge:2018icsme}.
To reduce these threats, we filtered forks based on  the following heuristics: $\geq 10$ stars, $\geq 10$ commits ahead of the mainline, $\geq 5$ closed pull requests, diverging \textsf{README} files.
...
We used open card sorting~\cite{zimmermann2016card}, on the 3 open-ended questions to ascertain the meaning and summarise the overarching themes of responses within the context of the research questions. 
