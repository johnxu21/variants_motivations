...
\textit{Variant forks} are, in contrast, created by splitting off a new development branch without necessarily intending to contribute back to the mainline.\cd{Are these definitions correct? Does a variant fork become a social fork if it is contributed back? If the real distinguishing factor is the next sentence, it should be incorporated in the definition.}
...
Developers tend to perceive social forks as alternatives to the original mainline project\cd{Is this supported by the literature?}, and variant forks often evolve out of them rather than being planned deliberately.
...
The literature pre-dating git identified three categories of motivations for creating variant forks: technical (e.g., diverging features), governance (e.g., diverging interests), legal (e.g., diverging licences), and personal (e.g., diverging principles).
...
\git offers advanced code-sharing facilities, yet at least one study reported very limited code integration between the mainline and the variant projects~\cite{businge:emse:2021}
...
we identify a new reasons\cd{one or more?} for creating and maintaining variant forks;
