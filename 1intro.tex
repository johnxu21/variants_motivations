...
Developers frequently perceive social forks as alternatives to the original mainline project, and variant forks often evolve out of them rather than being planned deliberately. \jb{don't we need to explicitly state the gap like we did in the abstract? ``Little is still known \ldots''}.
