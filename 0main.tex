...
Social coding platforms centred around git (e.g., \gh, GitLab, Bitbucket) provide explicit facilities to share code between projects: forks, pull requests, cherry-picking to name but a few.
...
In this paper we report the results of an exploratory study on the motivations behind variant fork creation and maintenance.
We conducted a survey among 112 maintainers of 105 active open source variant projects hosted on \gh, a very popular social coding platform.
