...
\sd{Is it a section on ``Limitations" or a section on ``Threats to Validity"?
You call it limitations below but you report them like threats to validity.}
...
\section{Conclusions}
\sd{The conclusion feels disconnected from the rest of the paper.
We should hint back at the ``Why" and ``How" more explicitly.
Also use the summaries at the end of the RQ1 to emphasize the findings better.
For the moment this reads to much like "We confirmed previous research and made some small but interesting observation". The ``so what'' is still missing here}
